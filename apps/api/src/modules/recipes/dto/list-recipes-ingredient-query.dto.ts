...
import {
  ...
  RecipesIngredientFilterSchemaValidator,
...
export class ListRecipesIngredientQueryDto extends QueryPaginationDto {
  @ApiPropertyOptional({
    description:
  ...
  @ApiPropertyOptional({
    ...
    example: 'ingredient_id:eq:12,quantity:gte:1',
    type: String,
  })
  @ValidateIf((_, value) => value !== undefined)
  @IsString({
  ...
  @Validate(RecipesIngredientFilterSchemaValidator, {
